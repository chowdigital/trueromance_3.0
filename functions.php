...
function wordpress_bootstrap_starter_theme_scripts() {
	...
	wp_enqueue_style( 'Typekit', 'https://use.typekit.net/uql6zdr.css' );
	
	wp_enqueue_style( 'Cloudsdale-theme', get_stylesheet_uri(), array(), $ver = 1.4 );
    wp_enqueue_script( 'Bootstrap','https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js', array(), '1.0.0', true );
	...
	wp_enqueue_script( 'Custom', get_template_directory_uri() . '/assets/js/cloudsdale/cloudsdale.js', array(), '1.0.0', true );
