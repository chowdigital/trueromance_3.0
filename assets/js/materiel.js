...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(require('jquery'), require('popper.js')) : typeof define === 'function' && define.amd ? define(['jquery', 'popper.js'], factory) : (global = global || self, factory(global.jQuery, global.Popper));
})(void 0, function ($, Popper$1) {
  'use strict';
  ...
  function transitionEndEmulator(duration) {
    ...
    setTimeout(function () {
      if (!called) {
        Util.triggerTransitionEnd(_this5);
      }
    }, duration);
    return this;
  }
    ...
    _createClass2(Alert, [{
      ...
      value: function _removeElement(element) {
        ...
        $(element).one(Util.TRANSITION_END, function (event) {
          return _this6._destroyElement(element, event);
  ...
  var Event$1 = {
    ...
    FOCUS_BLUR_DATA_API: "focus".concat(EVENT_KEY$1).concat(DATA_API_KEY$1, " ") + "blur".concat(EVENT_KEY$1).concat(DATA_API_KEY$1)
  };
  /**
   * ------------------------------------------------------------------------
   * Class Definition
  ...
  var Event$2 = {
    SLIDE: "slide".concat(EVENT_KEY$2),
    SLID: "slid".concat(EVENT_KEY$2),
    KEYDOWN: "keydown".concat(EVENT_KEY$2),
    MOUSEENTER: "mouseenter".concat(EVENT_KEY$2),
    MOUSELEAVE: "mouseleave".concat(EVENT_KEY$2),
    TOUCHSTART: "touchstart".concat(EVENT_KEY$2),
    TOUCHMOVE: "touchmove".concat(EVENT_KEY$2),
    TOUCHEND: "touchend".concat(EVENT_KEY$2),
    POINTERDOWN: "pointerdown".concat(EVENT_KEY$2),
    POINTERUP: "pointerup".concat(EVENT_KEY$2),
    DRAG_START: "dragstart".concat(EVENT_KEY$2),
    LOAD_DATA_API: "load".concat(EVENT_KEY$2).concat(DATA_API_KEY$2),
    CLICK_DATA_API: "click".concat(EVENT_KEY$2).concat(DATA_API_KEY$2)
  };
  var ClassName$2 = {
    CAROUSEL: 'carousel',
    ACTIVE: 'active',
    ...
    _createClass2(Carousel, [{
      ...
      value: function _addEventListeners() {
        ...
        if (this._config.pause === 'hover') {
          $(this._element).on(Event$2.MOUSEENTER, function (event) {
            return _this8.pause(event);
          }).on(Event$2.MOUSELEAVE, function (event) {
            return _this8.cycle(event);
          });
        }
      ...
      value: function _addTouchEventListeners() {
        ...
        var start = function start(event) {
          if (_this9._pointerEvent && PointerType[event.originalEvent.pointerType.toUpperCase()]) {
            _this9.touchStartX = event.originalEvent.clientX;
          } else if (!_this9._pointerEvent) {
            _this9.touchStartX = event.originalEvent.touches[0].clientX;
          }
        };
        ...
        var move = function move(event) {
          ...
          if (event.originalEvent.touches && event.originalEvent.touches.length > 1) {
            _this9.touchDeltaX = 0;
          } else {
            _this9.touchDeltaX = event.originalEvent.touches[0].clientX - _this9.touchStartX;
          }
        };

        var end = function end(event) {
          if (_this9._pointerEvent && PointerType[event.originalEvent.pointerType.toUpperCase()]) {
            _this9.touchDeltaX = event.originalEvent.clientX - _this9.touchStartX;
          }
          ...
          if (_this9._config.pause === 'hover') {
            ...
            _this9.touchTimeout = setTimeout(function (event) {
      ...
      value: function _slide(direction, element) {
        ...
        if ($(this._element).hasClass(ClassName$2.SLIDE)) {
          ...
          $(activeElement).one(Util.TRANSITION_END, function () {
            $(nextElement).removeClass("".concat(directionalClassName, " ").concat(orderClassName)).addClass(ClassName$2.ACTIVE);
            $(activeElement).removeClass("".concat(ClassName$2.ACTIVE, " ").concat(orderClassName, " ").concat(directionalClassName));
            _this10._isSliding = false;
            setTimeout(function () {
              return $(_this10._element).trigger(slidEvent);
            }, 0);
          }).emulateTransitionEnd(transitionDuration);
        } else {
  ...
  var Event$3 = {
    ...
    CLICK_DATA_API: "click".concat(EVENT_KEY$3).concat(DATA_API_KEY$3)
  };
  var ClassName$3 = {
    SHOW: 'show',
    COLLAPSE: 'collapse',
  ...
  var Collapse = /*#__PURE__*/function () {
    ...
    _createClass2(Collapse, [{
      ...
      value: function show() {
        ...
        if (this._parent) {
          actives = [].slice.call(this._parent.querySelectorAll(Selector$3.ACTIVES)).filter(function (elem) {
            if (typeof _this11._config.parent === 'string') {
              return elem.getAttribute('data-parent') === _this11._config.parent;
            }
        ...
        var complete = function complete() {
          $(_this11._element).removeClass(ClassName$3.COLLAPSING).addClass(ClassName$3.COLLAPSE).addClass(ClassName$3.SHOW);
          _this11._element.style[dimension] = '';

          _this11.setTransitioning(false);

          $(_this11._element).trigger(Event$3.SHOWN);
        };
      ...
      value: function hide() {
        ...
        var complete = function complete() {
          _this12.setTransitioning(false);

          $(_this12._element).removeClass(ClassName$3.COLLAPSING).addClass(ClassName$3.COLLAPSE).trigger(Event$3.HIDDEN);
        };
      ...
      value: function _getParent() {
        ...
        $(children).each(function (i, element) {
          _this13._addAriaAndCollapsedClass(Collapse._getTargetFromElement(element), [element]);
        });
        return parent;
      }
    }, {
      ...
      value: function _jQueryInterface(config) {
        return this.each(function () {
          ...
          var _config = _objectSpread(_objectSpread(_objectSpread({}, Default$1), $this.data()), _typeof(config) === 'object' && config ? config : {});
  ...
  var Event$4 = {
    ...
    RESIZE: "resize".concat(EVENT_KEY$4),
    CLICK_DISMISS: "click.dismiss".concat(EVENT_KEY$4),
    KEYDOWN_DISMISS: "keydown.dismiss".concat(EVENT_KEY$4),
    MOUSEUP_DISMISS: "mouseup.dismiss".concat(EVENT_KEY$4),
    MOUSEDOWN_DISMISS: "mousedown.dismiss".concat(EVENT_KEY$4),
    CLICK_DATA_API: "click".concat(EVENT_KEY$4).concat(DATA_API_KEY$4)
  };
  var ClassName$4 = {
    ...
    _createClass2(Modal, [{
      ...
      value: function show(relatedTarget) {
        ...
        $(this._element).on(Event$4.CLICK_DISMISS, Selector$4.DATA_DISMISS, function (event) {
          return _this14.hide(event);
        });
        $(this._dialog).on(Event$4.MOUSEDOWN_DISMISS, function () {
          $(_this14._element).one(Event$4.MOUSEUP_DISMISS, function (event) {
            if ($(event.target).is(_this14._element)) {
              _this14._ignoreBackdropClick = true;
            }
          });
        });

        this._showBackdrop(function () {
          return _this14._showElement(relatedTarget);
        });
      }
    }, {
      key: "hide",
      value: function hide(event) {
        ...
        if (transition) {
          ...
          $(this._element).one(Util.TRANSITION_END, function (event) {
            return _this15._hideModal(event);
          }).emulateTransitionEnd(transitionDuration);
        } else {
          this._hideModal();
        }
      ...
      value: function _enforceFocus() {
        ...
        .on(Event$4.FOCUSIN, function (event) {
          if (document !== event.target && _this17._element !== event.target && $(_this17._element).has(event.target).length === 0) {
      ...
      value: function _setResizeEvent() {
        ...
        if (this._isShown) {
          $(window).on(Event$4.RESIZE, function (event) {
            return _this19.handleUpdate(event);
          });
        } else {
      ...
      value: function _hideModal() {
        ...
        this._showBackdrop(function () {
          ...
          _this20._resetAdjustments();

          _this20._resetScrollbar();

          $(_this20._element).trigger(Event$4.HIDDEN);
        });
      }
    }, {
      key: "_removeBackdrop",
      ...
      value: function _showBackdrop(callback) {
        ...
        if (this._isShown && this._config.backdrop) {
          ...
          $(this._element).on(Event$4.CLICK_DISMISS, function (event) {
            if (_this21._ignoreBackdropClick) {
              _this21._ignoreBackdropClick = false;
              return;
            }
      ...
      value: function _setScrollbar() {
        ...
        if (this._isBodyOverflowing) {
          ...
          $(fixedContent).each(function (index, element) {
            ...
            $(element).data('padding-right', actualPadding).css('padding-right', "".concat(parseFloat(calculatedPadding) + _this22._scrollbarWidth, "px"));
          }); // Adjust sticky content margin

          $(stickyContent).each(function (index, element) {
            var actualMargin = element.style.marginRight;
            var calculatedMargin = $(element).css('margin-right');
            $(element).data('margin-right', actualMargin).css('margin-right', "".concat(parseFloat(calculatedMargin) - _this22._scrollbarWidth, "px"));
          }); // Adjust body padding
      ...
      value: function _resetScrollbar() {
        ...
        var elements = [].slice.call(document.querySelectorAll("".concat(Selector$4.STICKY_CONTENT)));
      ...
      value: function _jQueryInterface(config, relatedTarget) {
        return this.each(function () {
          ...
          var _config = _objectSpread(_objectSpread(_objectSpread({}, Default$2), $(this).data()), _typeof(config) === 'object' && config ? config : {});
  ...
  $(document).on(Event$4.CLICK_DATA_API, Selector$4.DATA_TOGGLE, function (event) {
    ...
    var config = $(target).data(DATA_KEY$4) ? 'toggle' : _objectSpread(_objectSpread({}, $(target).data()), $(this).data());
  ...
  var Tooltip = /*#__PURE__*/function () {
    ...
    _createClass2(Tooltip, [{
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          this._popper = new Popper$1(this.element, tip, {
            ...
            onUpdate: function onUpdate(data) {
              return _this24._handlePopperPlacementChange(data);
            }
          });
      ...
      value: function setContent() {
        ...
        $(tip).removeClass("".concat(ClassName$5.FADE, " ").concat(ClassName$5.SHOW));
      }
    }, {
      ...
      value: function _getOffset() {
        ...
        if (typeof this.config.offset === 'function') {
          offset.fn = function (data) {
            data.offsets = _objectSpread(_objectSpread({}, data.offsets), _this26.config.offset(data.offsets, _this26.element) || {});
            return data;
          };
        } else {
  ...
  var Default$4 = _objectSpread(_objectSpread({}, Tooltip.Default), {}, {
    placement: 'right',
    trigger: 'click',
    content: '',
  ...
  var DefaultType$4 = _objectSpread(_objectSpread({}, Tooltip.DefaultType), {}, {
  ...
  var Popover = /*#__PURE__*/function (_Tooltip) {
    ...
    _createClass2(Popover, [{
      ...
      key: "addAttachmentClass",
      value: function addAttachmentClass(attachment) {
        $(this.getTipElement()).addClass("".concat(CLASS_PREFIX$1, "-").concat(attachment));
      }
    }, {
      key: "getTipElement",
      value: function getTipElement() {
      ...
      value: function setContent() {
        ...
        $tip.removeClass("".concat(ClassName$6.FADE, " ").concat(ClassName$6.SHOW));
      } // Private
  ...
  var Event$7 = {
    ACTIVATE: "activate".concat(EVENT_KEY$7),
    SCROLL: "scroll".concat(EVENT_KEY$7),
    LOAD_DATA_API: "load".concat(EVENT_KEY$7).concat(DATA_API_KEY$5)
  };
  var ClassName$7 = {
  ...
  var ScrollSpy = /*#__PURE__*/function () {
    function ScrollSpy(element, config) {
      ...
      this._config = this._getConfig(config);
      this._selector = "".concat(this._config.target, " ").concat(Selector$7.NAV_LINKS, ",") + "".concat(this._config.target, " ").concat(Selector$7.LIST_ITEMS, ",") + "".concat(this._config.target, " ").concat(Selector$7.DROPDOWN_ITEMS);
      this._offsets = [];
      this._targets = [];
      this._activeTarget = null;
      this._scrollHeight = 0;
      $(this._scrollElement).on(Event$7.SCROLL, function (event) {
        return _this28._process(event);
      });
      this.refresh();
    ...
    _createClass2(ScrollSpy, [{
      ...
      value: function refresh() {
        ...
        targets.map(function (element) {
          ...
          _this29._offsets.push(item[0]);

          _this29._targets.push(item[1]);
        });
      }
    }, {
      key: "dispose",
      ...
      key: "_getConfig",
      value: function _getConfig(config) {
        config = _objectSpread(_objectSpread({}, Default$5), _typeof(config) === 'object' && config ? config : {});
      ...
      value: function _activate(target) {
        ...
        if ($link.hasClass(ClassName$7.DROPDOWN_ITEM)) {
          ...
          $link.parents(Selector$7.NAV_LIST_GROUP).prev("".concat(Selector$7.NAV_LINKS, ", ").concat(Selector$7.LIST_ITEMS)).addClass(ClassName$7.ACTIVE); // Handle special case when .nav-link is inside .nav-item
  ...
  var Event$8 = {
    ...
    CLICK_DATA_API: "click".concat(EVENT_KEY$8).concat(DATA_API_KEY$6)
  };
  var ClassName$8 = {
    DROPDOWN_MENU: 'dropdown-menu',
    ACTIVE: 'active',
  ...
  var Tab = /*#__PURE__*/function () {
    ...
    _createClass2(Tab, [{
      ...
      value: function show() {
        ...
        var complete = function complete() {
          var hiddenEvent = $.Event(Event$8.HIDDEN, {
            relatedTarget: _this30._element
          });
          var shownEvent = $.Event(Event$8.SHOWN, {
            relatedTarget: previous
          });
          $(previous).trigger(hiddenEvent);
          $(_this30._element).trigger(shownEvent);
        };
      ...
      value: function _activate(element, container, callback) {
        ...
        var complete = function complete() {
          return _this31._transitionComplete(element, active, callback);
        };
